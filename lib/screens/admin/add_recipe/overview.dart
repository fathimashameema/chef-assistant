...
class Overview extends StatefulWidget {
  ...
  // static String Title = Overview.titleController.text;
  // static String description = Overview.descriptionController.text;
  // static String prepTime = Overview.prepTimeController.text;
