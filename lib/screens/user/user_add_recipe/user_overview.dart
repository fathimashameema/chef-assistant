  ...
  Future<void> pickImage() async {
    ...
    if (image != null) {
      ...
      setState(() {
        ...
        UserRecipeValues.obj.image = imageData;
      });
      print(UserRecipeValues.obj.image);
    }
  }
                  ...
                  onPressed: () {
                    if (_formkey.currentState != null &&
                      ...
                      if (selectedValue == null) {
                        showDialog(
                          ...
                          builder: (ctx) {
                            return customAlertDialogue(
                              content:
                                  const Text("Please select if Vegan or Non-veg"),
                              actions: [
                                TextButton(
                                  onPressed: () {
                        ...
                        UserRecipeValues.obj.description =
                            descriptionController.text;
                        UserRecipeValues.obj.prepTime = prepTimeController.text;
                        UserRecipeValues.obj.title = titleController.text;
                        UserRecipeValues.obj.isVeg = isVeg;
                        print(UserRecipeValues.obj.description);
